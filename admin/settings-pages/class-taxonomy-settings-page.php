...
class CCA_Taxonomy_Settings_Page extends MOOBD_Settings_Page {




	public function __construct( ) { //MOOBD_Settings_Page $email_tab ) {
		$option_key = 'cca_taxonomies';
		parent::__construct( 'cca_taxonomies_settings_options_pages', $option_key ); //, 'Taxonomies', $tab_page );
